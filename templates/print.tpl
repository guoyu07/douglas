<html>
    ...
    <body>
        <h1>Douglas Miller Scholarship Application for {first_name} {last_name}</h1>
        <table cellpadding="4"  border="1" style="width : 100%; margin-bottom : 2em">
            ...
            <tr>
                <th style="width : 20%">Professional supervisor</th>
                <td style="width : 30%">{professional_super}</td>
